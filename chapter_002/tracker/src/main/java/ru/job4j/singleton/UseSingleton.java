...
public class UseSingleton {
    public static void main(String[] args) {
        ...
        tracker1.tracker.delete(tracker1.tracker.findByName("e1")[0].getId());
        ...
        tracker3.tracker.delete(tracker3.tracker.findByName("e1")[0].getId());
        ...
        tracker5.tracker.delete(tracker5.tracker.findByName("e1")[0].getId());
        ...
        tracker7.tracker.delete(tracker7.tracker.findByName("e1")[0].getId());
    }
}
